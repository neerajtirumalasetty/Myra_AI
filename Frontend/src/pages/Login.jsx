    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-emerald-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* left */}
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border-purple-200 bg-purple-100 text-purple-600 text-sm font-medium">
              <RiSparkling2Line />
            ...
            <p className="mt-8 text-lg text-[#475569] leading-8 max-w-2xl">
              Create smart AI voice assistants for your website. Help users with
            ...
            <p className="mt-4 text-sm text-[#647448b]">
              Free plan includes 250 AI responses
            </p>
          </div>
