  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] overflow-hidden">
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20">
        <div className="absloute inset-0 bg-gradient-to-br from-purple-50 via-white to-emerald-50" />
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="text-center mt-10 sm:mt-12">
            ...
            <p className="max-w-2xl mx-auto mt-7 text-sm sm:text-lg lg:text-xl text-[#64748b] leading-relaxed px-2">
              Empower your website with an intelligent voice assistant that
              engages visitors, answers their questions, and helps them navigate
            ...
            >
              <button className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-purple-500 to-emerald-500 text-white font-semibold text-sm sm:text-base shadow-[0_12px_40px_rgba(168,85,247,0.25)] hover:scale-[1.02] tranistion-all cursor-pointer">
                Build Your Assistant
              </button>
            </div>

            <p className="mt-5 text-xs sm:text-sm text-gray-400">
              Free plan include 250 AI responses
            </p>
          </div>
          <AssistantPreview />
        </div>
      ...
      <footer className="bg-[#081028] px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left">
          ...
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Myra AI. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
